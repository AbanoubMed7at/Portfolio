...
# A table containing the following three fields for all individuals whose employee number is no greater than 10040:
 -- employee number
...
# create a function that accepts a second parameter which would be a character sequence. 
